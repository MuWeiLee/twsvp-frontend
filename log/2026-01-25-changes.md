...
- 个人中心新增「编辑简介」入口与简介展示区块。
- 观点卡片发布时间统一为「今天/昨天/近7天/近1年/超过1年」格式。
- 观点内容点击统一进入观点详情页（搜索/个人/他人/个股/观点流）。
...
- 未提交
  - `src/views/ProfileView.vue`：新增简介编辑入口 + 观点卡片发布时间格式与内容点击跳转修正。
  - `src/views/FeedView.vue`：观点卡片发布时间格式与内容点击跳转修正。
  - `src/views/FeedCardView.vue`：观点详情页发布时间格式统一。
  - `src/views/SearchView.vue`：搜索观点卡片发布时间格式与内容点击跳转修正。
  - `src/views/PersonalViewerView.vue`：观点卡片发布时间格式与内容点击跳转修正。
  - `src/views/StockFeedView.vue`：观点卡片发布时间格式与内容点击跳转修正。
  - `src/services/feeds.js`：新增统一发布时间格式化函数。
