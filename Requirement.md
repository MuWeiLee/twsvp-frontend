...
### 视觉风格（E-Paper 主题）
- **基调**：纸白/浅灰、低对比、易于长文阅读
- **背景/卡片**：页面底色 `#F7F7F5`，卡片 `#FFFFFF`，分区底 `#FAFAF8`
- **文字层级**：主文字 `#1F1F1F`，次要 `#4A4A4A`，辅助 `#7A7A7A`
- **强调颜色**：看多 `#E6F0EB / #2F6F4E`，看空 `#F2E8E8 / #8C3A3A`
- **排版**：中文字体 Source Han Serif，英文与数字 Inter
- **视觉限制**：避免 emoji、渐变、发光与强烈阴影
---
...
### 1.2 产品目标
TWSVP 旨在建立一个**「投资观点记录与回溯平台」**，实现以下功能：
...
### 11.1 产品核心价值
TWSVP 作为台股投资观点记录与回溯平台，通过结构化的观点发布和强制性的结果绑定，为用户提供：
- 🎯 **可验证的判断记录**
- 📊 **长期可信度沉淀**
- ⚖️ **客观的绩效回溯**
